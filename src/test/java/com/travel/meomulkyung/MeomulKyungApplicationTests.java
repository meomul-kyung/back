...
@SpringBootTest(properties = {
        ...
        "spring.jpa.hibernate.ddl-auto=create-drop", "jwt.secret=application-context-test-secret-that-is-at-least-32-bytes",
        "jwt.access-token-validity=1800000", "spring.security.oauth2.client.registration.kakao.client-id=test-kakao",
